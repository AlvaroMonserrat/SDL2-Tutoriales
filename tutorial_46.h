#ifndef TUTORIAL_46_H_INCLUDED
#define TUTORIAL_46_H_INCLUDED
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO | SDL_INIT_TIMER) < 0){
		...
		srand( SDL_GetTicks() );
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 46", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
