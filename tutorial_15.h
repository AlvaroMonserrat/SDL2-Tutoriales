#ifndef TUTORIAL_15_H_INCLUDED
#define TUTORIAL_15_H_INCLUDED
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO) < 0){
        ...
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 15", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
...
bool loadMedia(){
    ...
    if(gFont == NULL){
        ...
        if(!gTextTexture.loadFromRenderedText("Este texto es de ejemplo de texto renderizado", textColor)){
