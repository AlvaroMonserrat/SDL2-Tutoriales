#ifndef TUTORIAL_43_H_INCLUDED
#define TUTORIAL_43_H_INCLUDED
...
bool loadMedia(){
    ...
    //Load blank texture
    if(!gCallBackTexture.loadFromFile("images/background.png"))
    {
...
void gameRun(){
    ...
    else
    {
        ...
        {
            char* p = "3 second waited";
            SDL_TimerID timerID = SDL_AddTimer(3 * 1000, callback, p);
