#ifndef TUTORIAL_12_H_INCLUDED
#define TUTORIAL_12_H_INCLUDED

#include<iostream>
#include<SDL2/SDL.h>
#include<SDL2/SDL_image.h>
/*
    Tutorial 12: Transparencia Composición Alfa (Alpha Blending)
*/
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO) < 0){
        ...
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 12", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
...
bool loadMedia(){
    ...
    if(!gModulatedTexture.loadFromFile("images/fadeout.png")){
        cout << "La imagen fade out no pudo ser cargada: " << SDL_GetError() << endl;
        success=false;
    }else{
    ...
    if(!gBackgroundTexture.loadFromFile("images/fadein.png")){
        cout << "La imagen fade in no pudo ser cargada: " << SDL_GetError() << endl;
        success=false;
    }
