#ifndef TUTORIAL_22_H_INCLUDED
#define TUTORIAL_22_H_INCLUDED
...
/*
    Tutorial 22: Frames por segundos
*/
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO) < 0){
        ...
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 22", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
