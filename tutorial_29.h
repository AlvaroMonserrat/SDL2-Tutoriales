#ifndef TUTORIAL_29_H_INCLUDED
#define TUTORIAL_29_H_INCLUDED
...
/*
    Tutorial 29: Scrolling Backgrounds
*/
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO) < 0){
        ...
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 29", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
