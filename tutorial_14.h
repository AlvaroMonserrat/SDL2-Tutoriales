#ifndef TUTORIAL_14_H_INCLUDED
#define TUTORIAL_14_H_INCLUDED

#include<iostream>
#include<SDL2/SDL.h>
#include<SDL2/SDL_image.h>
/*
    Tutorial 14: Rotación y volteo
*/
...
bool init(){
    ...
    if( SDL_Init(SDL_INIT_VIDEO) < 0){
        ...
        //Crear la ventana
        gWindow = SDL_CreateWindow("Tutorial 14", 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if( gWindow == NULL){
